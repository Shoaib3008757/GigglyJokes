...
public class JokeCustomAdapter extends BaseAdapter{

    private ArrayList<JokeGetterSetter> mListItems;
    private LayoutInflater mLayoutInflater;
    Context context;

    public JokeCustomAdapter(Context context, ArrayList<JokeGetterSetter> arrayList){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = mLayoutInflater.inflate(R.layout.jokecustomlayout, viewGroup, false);

            // get all views you need to handle from the cell and save them in the view holder
            holder.emojiImage = (ImageView) view.findViewById(R.id.emoji);
            holder.jokeText = (TextView) view.findViewById(R.id.joketext);
        ...
        JokeGetterSetter stringItem = mListItems.get(position);
        if (stringItem != null) {
            //set the item name on the TextView
            holder.emojiImage.setImageResource(stringItem.getEmoji());
            holder.jokeText.setText(stringItem.getJokeText());
            ...
            holder.jokeText.setText("Unknown");
        }
